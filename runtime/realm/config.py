...
DIVISIONS = {
    ...
    "gamedev": {
        ...
        "abilities": [
            ...
            {"name": "Forge a Soul",      "desc": "Creates characters with depth — stats, backstory, and visual identity in one stroke"},
            {"name": "Spawn the Beast",   "desc": "Designs enemies and bosses with AI behaviors, phases, and loot tables"},
            {"name": "Run the Gauntlet",  "desc": "Automated iteration: generate, review, fix, test — until the code holds"},
        ],
        "skills": {
            ...
            "character-designer":  {"xp": 12, "soldier": "The Character Smith",  "icon": "👤", "anim": "forge",   "label": "Forge a Soul"},
            "item-forge":          {"xp": 10, "soldier": "The Artificer",        "icon": "⚔",  "anim": "forge",   "label": "Forge an Artifact"},
            "enemy-designer":      {"xp": 12, "soldier": "The Beastwright",      "icon": "👹", "anim": "spark",   "label": "Spawn the Beast"},
            "quest-writer":        {"xp": 12, "soldier": "The Quest Scribe",     "icon": "📜", "anim": "compose", "label": "Write the Quest"},
            "story-writer":        {"xp": 15, "soldier": "The Lorekeeper",       "icon": "📖", "anim": "compose", "label": "Write the Legend"},
            "skill-tree-builder":  {"xp": 10, "soldier": "The Talent Weaver",    "icon": "🌳", "anim": "compose", "label": "Weave the Tree"},
            "asset-requester":     {"xp":  8, "soldier": "The Requisitioner",    "icon": "📋", "anim": "scan",    "label": "Request the Arsenal"},
